...
export type GetLessonBySlugQuery = {
    ...
    lesson?: {
        ...
        teacher?: { __typename?: 'Teacher'; name: string; bio: string; avatarURL: string } | null;
    } | null;
};
...
export type GetLessonsQuery = {
    __typename?: 'Query';
    lessons: Array<{ __typename?: 'Lesson'; title: string; slug: string; availableAt: any; lessonType: LessonType }>;
};
